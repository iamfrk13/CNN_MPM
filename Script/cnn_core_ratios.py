...
# Paths 
train_dir = r"E:/Sentinel_Dataset/cnn/model_datasets/core_ratios_dataset/train"
val_dir   = r"E:/Sentinel_Dataset/cnn/model_datasets/core_ratios_dataset/validation"
test_dir  = r"E:/Sentinel_Dataset/cnn/model_datasets/core_ratios_dataset/test"
...
callbacks = [
    keras.callbacks.ModelCheckpoint(filepath="convnet_core_ratios_scratch.keras", save_best_only=True, monitor="val_loss")
]
...
test_model = keras.models.load_model("convnet_core_ratios_scratch.keras")
...
# Save & name the best model as "convnet_core.keras" automatically using a callback
callbacks = [
    keras.callbacks.ModelCheckpoint(filepath="convnet_core_ratios_aug.keras", save_best_only=True, monitor="val_loss")
]
...
# Load the best saved model and evaluate on test dataset
test_model = keras.models.load_model("convnet_core_ratios_aug.keras")
test_loss, test_acc = test_model.evaluate(test_dataset)
print(f"Test accuracy: {test_acc:.3f}")
...
callbacks = [
    keras.callbacks.ModelCheckpoint(filepath="convnet_core_ratios_finetuned_1.keras", save_best_only=True, monitor="val_loss")
]
...
# Load the best saved model and evaluate on test dataset
test_model = keras.models.load_model("convnet_core_ratios_finetuned_1.keras")
test_loss, test_acc = test_model.evaluate(test_dataset)
print(f"Test accuracy: {test_acc:.3f}")
...
model = keras.models.load_model("convnet_core_ratios_finetuned_1.keras")
...
fine_tune_callbacks = [
    keras.callbacks.ModelCheckpoint(
        filepath="convnet_core_ratios_finetuned_2.keras",
        save_best_only=True,
        monitor="val_loss")
]
...
# Load the best saved model and evaluate on test dataset
test_model = keras.models.load_model("convnet_core_ratios_finetuned_2.keras")
test_loss, test_acc = test_model.evaluate(test_dataset)
print(f"Test accuracy: {test_acc:.3f}")
